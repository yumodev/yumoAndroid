...
import com.yumodev.test.OnPackageObserver;
...
public class PackageInstall {
    ...
    private OnPackageObserver onInstalledPackaged;
    ...
    public void init(Context context) throws SecurityException, NoSuchMethodException {
    ...
    public void setOnPackagedObserver(OnPackageObserver onInstalledPackaged) {
