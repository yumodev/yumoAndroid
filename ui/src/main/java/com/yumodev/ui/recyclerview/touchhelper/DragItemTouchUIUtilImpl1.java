...
import com.yumodev.ui.recyclerview.DragRecyclerView.DragItemTouchHelper;

/**
 * Package private class to keep implementations. Putting them inside ItemTouchUIUtil makes them
 * public API, which is not desired in this case.
 */
class DragItemTouchUIUtilImpl1 {
    static class Lollipop extends DragItemTouchUIUtilImpl1.Honeycomb {
        @Override
    ...
    static class Gingerbread implements ItemTouchUIUtil {
        ...
        public void onDraw(Canvas c, RecyclerView recyclerView, View view,
                           float dX, float dY, int actionState, boolean isCurrentlyActive) {
            if (actionState != DragItemTouchHelper.ACTION_STATE_DRAG) {
