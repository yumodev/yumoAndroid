package com.yumodev.ui.recyclerview.touchhelper;
 ...
 *
 */
public class DragItemTouchHelper1 extends RecyclerView.ItemDecoration
     ...
     */
    DragItemTouchHelper1.Callback mCallback;
    ...
    private final RecyclerView.OnItemTouchListener mOnItemTouchListener
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (mSelected == null) {
                    final DragItemTouchHelper1.RecoverAnimation animation = findAnimation(event);
                    if (animation != null) {
     ...
     */
    public DragItemTouchHelper1(DragItemTouchHelper1.Callback callback) {
        mCallback = callback;
    }
    ...
    private void destroyCallbacks() {
        ...
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final DragItemTouchHelper1.RecoverAnimation recoverAnimation = mRecoverAnimations.get(0);
    ...
    private void initGestureDetector() {
        ...
        mGestureDetector = new GestureDetectorCompat(mRecyclerView.getContext(),
                new DragItemTouchHelper1.ItemTouchHelperGestureListener());
    }
    ...
    void select(RecyclerView.ViewHolder selected, int actionState) {
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                final DragItemTouchHelper1.RecoverAnimation rv = new DragItemTouchHelper1.RecoverAnimation(prevSelected, animationType,
    ...
    void postDispatchSwipe(final DragItemTouchHelper1.RecoverAnimation anim, final int swipeDir) {
    ...
    int endRecoverAnimation(RecyclerView.ViewHolder viewHolder, boolean override) {
        final int recoverAnimSize = mRecoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final DragItemTouchHelper1.RecoverAnimation anim = mRecoverAnimations.get(i);
     ...
     * {@link DragItemTouchHelper1.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{@link DragItemTouchHelper1.Callback} must have dragging enabled.</li>
     ...
     *                   RecyclerView.
     * @see DragItemTouchHelper1.Callback#isItemViewSwipeEnabled()
     */
     ...
     * behavior
     * by overriding {@link DragItemTouchHelper1.Callback}
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper is attached.</li>
     * <li>{@link DragItemTouchHelper1.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
    ...
    DragItemTouchHelper1.RecoverAnimation findAnimation(MotionEvent event) {
        ...
        if (Math.abs(mDx) > Math.abs(mDy)) {
            if ((swipeDir = checkHorizontalSwipe(viewHolder, flags)) > 0) {
                ...
                if ((originalFlags & swipeDir) == 0) {
                    // convert to relative
                    return DragItemTouchHelper1.Callback.convertToRelativeDirection(swipeDir,
                            ViewCompat.getLayoutDirection(mRecyclerView));
                }
                return swipeDir;
            }
     ...
     * {@link DragItemTouchHelper1}.
     */
    public static interface ViewDropHandler {

        /**
         * Called by the {@link DragItemTouchHelper1} after a View is dropped over another View.
         * <p>
     ...
     * {@link DragItemTouchHelper1.SimpleCallback}.
     * <p>
     * If user drags an item, ItemTouchHelper will call
     * {@link DragItemTouchHelper1.Callback#onMove(RecyclerView, RecyclerView.ViewHolder, RecyclerView.ViewHolder)
    ...
    public abstract static class Callback {
        ...
        static {
            if (Build.VERSION.SDK_INT >= 21) {
                sUICallback = new DragItemTouchUIUtilImpl1.Lollipop();
            } else if (Build.VERSION.SDK_INT >= 11) {
                sUICallback = new DragItemTouchUIUtilImpl1.Honeycomb();
            } else {
                sUICallback = new DragItemTouchUIUtilImpl1.Gingerbread();
            }
        }

        /**
         * Returns the {@link ItemTouchUIUtil} that is used by the {@link DragItemTouchHelper1.Callback} class for
         * visual
         ...
         * <p>
         * By default, {@link DragItemTouchHelper1.Callback} applies these changes on
         ...
         * </pre>
         *
         * @return The {@link ItemTouchUIUtil} instance that is used by the {@link DragItemTouchHelper1.Callback}
         */
         ...
         *                    it is cleared.
         * @param actionState One of {@link DragItemTouchHelper1#ACTION_STATE_IDLE},
         *                    {@link DragItemTouchHelper1#ACTION_STATE_SWIPE} or
         *                    {@link DragItemTouchHelper1#ACTION_STATE_DRAG}.
        ...
        public void onMoved(final RecyclerView recyclerView,
            ...
            if (layoutManager instanceof DragItemTouchHelper1.ViewDropHandler) {
                ((DragItemTouchHelper1.ViewDropHandler) layoutManager).prepareForDrop(viewHolder.itemView,
                        target.itemView, x, y);
                return;
            }
        ...
        void onDraw(Canvas c, RecyclerView parent, RecyclerView.ViewHolder selected,
            ...
            for (int i = 0; i < recoverAnimSize; i++) {
                final DragItemTouchHelper1.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
     ...
     * </pre>
     */
    public abstract static class SimpleCallback extends DragItemTouchHelper1.Callback {
