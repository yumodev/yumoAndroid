 ...
 * {@link YmItemTouchHelper.Callback} class or implementing {@link YmItemTouchHelper.ViewDropHandler}
 ...
 */
public class YmItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    private static final String TAG = "YmItemTouchHelper";
     ...
     * {@link YmItemTouchHelper.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{@link YmItemTouchHelper.Callback} must have dragging enabled.</li>
     ...
     *                   RecyclerView.
     * @see YmItemTouchHelper.Callback#isItemViewSwipeEnabled()
     */
     ...
     * behavior
     * by overriding {@link YmItemTouchHelper.Callback}
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper is attached.</li>
     * <li>{@link YmItemTouchHelper.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
     ...
     * {@link YmItemTouchHelper}.
     */
    public static interface ViewDropHandler {

        /**
         * Called by the {@link YmItemTouchHelper} after a View is dropped over another View.
         * <p>
    ...
    public abstract static class Callback {
        ...
        static {
            if (Build.VERSION.SDK_INT >= 21) {
                sUICallback = new YmItemTouchUIUtilImpl.Lollipop();
            } else if (Build.VERSION.SDK_INT >= 11) {
                sUICallback = new YmItemTouchUIUtilImpl.Honeycomb();
            } else {
                sUICallback = new YmItemTouchUIUtilImpl.Gingerbread();
            }
        }
         ...
         *                    it is cleared.
         * @param actionState One of {@link YmItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link YmItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link YmItemTouchHelper#ACTION_STATE_DRAG}.
         *
        ...
        private void onDraw(Canvas c, RecyclerView parent, RecyclerView.ViewHolder selected,
                            List<YmItemTouchHelper.RecoverAnimation> recoverAnimationList,
                            int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
                final YmItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
