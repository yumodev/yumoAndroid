...
public class TestProviderFragment extends YmTestFragment {
    ...
    public void testInsertBook(){
        ...
        contentValues.put(BookContentProvider.BOOK_FIELD_NAME, "name");
    ...
    public void testQueryBook(){
        ...
        while (cursor.moveToNext()){
            int  id = cursor.getInt(cursor.getColumnIndex(BookContentProvider.BOOK_FIELD_ID));
            String name = cursor.getString(cursor.getColumnIndex(BookContentProvider.BOOK_FIELD_NAME));
