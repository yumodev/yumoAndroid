...
public class SoftInputViewDialog extends Dialog {
    ...
    private void createEditText(){
        ...
        editView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewUtils.dip2px(getContext(), 20)));
    ...
    private View getSoftInputView(){
        ...
        textView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewUtils.dip2px(getContext(), 20)));
    ...
    private void showSoftInputView(int inputHeight){
        if (!mSoftInputBar.isShowing()){
            mSoftInputBar.setContentView(getSoftInputView())
                    .setWidth(ViewUtils.getScreenWidth(getContext()))
                    .setHeight(ViewUtils.dip2px(getContext(), 20))
