 ...
 * yumo
 */
public class VideoMediaPlayerActivity extends Activity implements View.OnClickListener {
    private final String TAG = VideoMediaPlayerActivity.class.getSimpleName() + "  ";
