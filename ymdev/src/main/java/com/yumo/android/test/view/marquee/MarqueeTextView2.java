...
public class MarqueeTextView2 extends TextView {
    private String LOG_TAG = "MarqueeTextView2";
    ...
    public void resumeScroll() {
        ...
        mScrollingLen = calculateScrollingLen();
        Log.i(LOG_TAG, "width:"+getWidth()+" "+calculateScrollingLen());
        if (getWidth() >= mScrollingLen + 10){
            setScrollX(0);
            setScrollY(0);
            return;
        }
...
//            invalidate();
    ...
    private void startScrollAnim(){
        if (mObjectAnimator == null){
            mObjectAnimator = ObjectAnimator.ofFloat(this, "translationX", 0,  mScrollingLen);
            mObjectAnimator.setRepeatCount(ValueAnimator.INFINITE);
            mObjectAnimator.setRepeatMode(ValueAnimator.RESTART);
            mObjectAnimator.setDuration(ROLLING_INTERVAL_DEFAULT);
